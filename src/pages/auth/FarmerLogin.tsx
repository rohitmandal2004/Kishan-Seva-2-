...
export default function FarmerLogin() {
 ...
 const { user, farmer, isConfigured, isProfileLoading, refreshProfile, signOut, resolveRole, setDemoRole, setFarmer } = useSupabase();
 ...
 <Link to="/farmer/register" className="text-emerald-700 hover:text-emerald-800 font-bold hover:underline transition">
 Register Profile
 </Link>
 </p>
 <div className="pt-2">
 ...
 className="text-[11px] text-emerald-800 bg-emerald-50 hover:bg-emerald-100 font-bold px-3 py-1.5 rounded-lg transition-colors border border-emerald-200 cursor-pointer"
 >
