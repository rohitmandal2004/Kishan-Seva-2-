        ...
        {currentStep === 1 && (
          <div className="bg-white border-zinc-200 shadow-sm rounded-md p-6 sm:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {anomalyReport.isSuspicious && (
              <div className="mb-6 p-4 bg-amber-50/80 border border-amber-200/50 rounded-lg flex gap-3 text-amber-900">
            ...
            <div className="p-6 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-md shadow-lg text-white flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative overflow-hidden">
