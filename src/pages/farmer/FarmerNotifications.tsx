    ...
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-6">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">{t('notifications_subtitle')}</p>
        </div>
        <button
      ...
      <Card className="border border-slate-200 rounded-lg overflow-hidden shadow-sm bg-white">
        {notifications.length === 0 ? (
          <div className="p-12 text-center text-slate-500">
            ...
            <p className="font-medium text-slate-700">{t('no_notifications')}</p>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-1 gap-2">
                    <h3 className={`text-sm leading-snug ${!n.read ? 'font-semibold text-emerald-950' : 'font-medium text-slate-800'}`}>
                      {n.title}
                    </h3>
