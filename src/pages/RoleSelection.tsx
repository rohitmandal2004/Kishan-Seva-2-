...
export default function RoleSelection() {
 ...
 className="p-5 sm:p-7 border-2 border-emerald-100 hover:border-emerald-600 transition duration-300 cursor-pointer bg-white hover:shadow-2xl group flex flex-col justify-between h-full rounded-3xl relative overflow-hidden"
 >
 ...
 <Button className="w-full mt-6 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl text-xs font-bold h-11 shadow-md hover:shadow-lg transition">
 ...
 className="p-5 sm:p-7 border-2 border-blue-100 hover:border-blue-600 transition duration-300 cursor-pointer bg-white hover:shadow-2xl group flex flex-col justify-between h-full rounded-3xl relative overflow-hidden"
 >
 ...
 <Button className="w-full mt-6 bg-blue-700 hover:bg-blue-800 text-white rounded-xl text-xs font-bold h-11 shadow-md hover:shadow-lg transition">
 ...
 className="p-5 sm:p-7 border-2 border-purple-100 hover:border-purple-600 transition duration-300 cursor-pointer bg-white hover:shadow-2xl group flex flex-col justify-between h-full rounded-3xl relative overflow-hidden"
 >
 ...
 <Button className="w-full mt-6 bg-purple-700 hover:bg-purple-800 text-white rounded-xl text-xs font-bold h-11 shadow-md hover:shadow-lg transition">
