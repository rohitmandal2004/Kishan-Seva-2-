                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <Badge className={`text-[10px] px-2 py-0.5 rounded-full font-bold border-0 ${item.status === 'COMPLETED' ? 'bg-emerald-100 text-emerald-800' :
                                        ...
                                        <div className="flex flex-wrap items-center gap-2.5 text-xs text-slate-500">
                                            <span className="font-semibold text-slate-800 flex items-center gap-1">
                                                <User className="w-3 h-3 text-slate-500" /> {item.farmer_name}
                                            </span>
                                            <span>•</span>
                                            <span className="font-medium text-emerald-700">{item.crop_name} ({item.expected_quantity_q} Q)</span>
                                            <span>•</span>
                                            <span className="font-mono text-slate-500">{item.vehicle_number}</span>
                                        </div>
                                    </div>
                                </div>
