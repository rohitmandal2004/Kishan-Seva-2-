...
export default function QualityCheck() {
 ...
 {success ? (
 <Card
 className={`p-12 border-2 text-center rounded-3xl animate-in zoom-in-95 ${
 grade === 'Rejected'
 ...
 >
 <div
 className={`w-20 h-20 text-white rounded-full flex items-center justify-center mx-auto mb-5 shadow-lg ${
 grade === 'Rejected'
 ...
 <h3
 className={`text-2xl font-black mt-3 mb-2 ${
 grade === 'Rejected' ? 'text-red-950' : 'text-emerald-900'
 }`}
 >
 ...
 <Badge
 className={`text-xs font-extrabold px-3 py-1 border-0 ${
 grade === 'Grade A'
 ...
 errors.rejectionReason ? 'border-red-500 focus-visible:ring-red-500' : ''
 }`}
 />
