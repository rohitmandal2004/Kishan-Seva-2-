...
export function SupabaseStatusBadge() {
 ...
 className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-bold transition bg-emerald-500/10 text-emerald-800 border border-emerald-500/20 hover:bg-emerald-500/20 shadow-xs"
