...
const AnimatedExternalLink = ({
 ...
 {children}
 <svg
 className="ml-[0.3em] size-[0.55em] translate-y-1 opacity-0 transition duration-300 group-hover:translate-y-0 group-hover:opacity-100"
 fill="none"
 viewBox="0 0 10 10"
...
const AnimatedHighlightLink = ({
 ...
 "before:origin-left before:transition before:duration-300 before:ease-in-out",
